...
return [
    ...
    [
        ...
        "type" => "comic book",
        "artists" =>"Clayton Henry, Gleb Melnikov, Dale aglesham",
        "writers" =>"Joshua Williamson",
    ],
    [
        "id"=> 108,
        "title" => "BATMAN: THE JOKER WARZONE",
        ...
        "sale_date" => "2020-09-29",
        "type" => "comic book",
        "artists" =>"Guillem March, Ashley A. Woods, Olivir Coipe, James Stokoe, Darko Lafuente",
    ...
    [
        "id"=> 110,
        "title" => "BATMAN: WHITE KNIGHT PRESENT: HARLEY QUINN",
